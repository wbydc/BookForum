<div class="container col-md-9 col-sm-12">
  <div class="posts-area col-md-12 no-bg">
    ...
    <form action="/post/article" method="POST">
      <h2>Заголовок:</h2>
      <input class="nai" type="text" name="header">
      <br/>
      <h2>Текст статьи:</h2>
      <textarea class="nai" name="text" rows="7"></textarea>
      <h2>Теги:</h2>
      <input class="nai" type="text" name="tags">
      <br/>
      <input class="pull-right" type="submit" value="Отправить">
    </form>
  </div>
</div>
